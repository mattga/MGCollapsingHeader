...
Pod::Spec.new do |s|
  ...
  s.summary      = "An iOS UIView subclass to manage collapsing and expanding of a header view. Subviews of the header are configured to transform to any collapsed layout"
  s.description  = <<-DESC
  ...
  s.source       = { :git => "https://github.com/mattga/MGCollapsibleHeader.git" }
